...
const (
	updateUrl    = "https://github.com/chenzhisheng95/octopus/releases/latest/download"
	updateApiUrl = "https://api.github.com/repos/chenzhisheng95/octopus/releases/latest"
)
